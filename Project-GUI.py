...
class Window(Frame):
    def __init__(self, master=None):
        ...
        self.canvas.pack()
        print("GUI and opening of image: PASS")
    ...
    def open_file(self):
        ...
        ret, image = cap.read()
        cv2.imwrite('preview.jpg',
                    image)

        self.show_image('preview.jpg')
        print("open_file function: PASS")
    ...
    def show_image(self, frame):
        ...
        self.canvas.pack()
        print("show_image function: PASS")

    def regionOfInterest(self):
        root.config(cursor="plus")
        self.canvas.bind("<Button-1>", self.imgClick)
        print("regionOfInterest function: PASS")
    ...
    print("main_process function for video: PASS")
